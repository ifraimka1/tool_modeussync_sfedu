...
$string['syncservice_base_url_desc'] = 'Base domain or IP address for SyncService, for example https://www.syncservice.com/';
$string['internal_api_key'] = 'Internal API key';
$string['internal_api_key_desc'] = 'API key used for SyncService requests.';
$string['missinginternalapikey'] = 'Internal API key is not configured.';
$string['syncrequestfailed'] = 'SyncService request failed.';
$string['invalidassignmentname'] = 'Invalid assignment item';
$string['invalidassignmentpayload'] = 'The assignment payload is missing a valid id, name, or positive grade.';
$string['unsupportedmodule'] = 'The selected module type is not supported.';
$string['moduleidnumberconflict'] = 'A course module with this Modeus identifier already exists with a different type.';
$string['eventassignmentsqueued'] = 'Assignments queued';
$string['cannotacquirequeuelock'] = 'Cannot acquire the Modeus queue lock.';
$string['privacy:metadata:queueitems'] = 'Assignment queue items manually created by a Moodle user.';
$string['privacy:metadata:queueitems:createdby'] = 'The user who confirmed creation of the Moodle activity.';
$string['privacy:exportpath'] = 'Modeus assignment creation';
